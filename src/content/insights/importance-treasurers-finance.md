...
coverImageAlt: "Against a near-black background, a wide slab of filled cream squares, three rows deep, spans the upper half. Beneath it, the exact centre, one narrow ash column carries the slab down to a fine line baseline; either side two faint outline-drawn columns touch the slab but carry nothing. The lower rule reads 'TREASURY, LOAD-BEARING'."
coverAnimation: importance-treasurers-finance
---
